...
public class GetSplitTest {
    ...
    public static List<byte[]> getSplitKeyValues(byte[] start, byte[] end, int startSplitPoint, int splitStep,
            int plateNum, boolean isTextKey) {
    ...
    private static byte[] buildKeyByRule(int keyValue, byte[] souceByte, int startSplitPoint, int splitStep) {
        // 转换字符串
    ...
    private static byte[] replaceBytes(byte[] souceByte, byte[] replaceByte, int startSplitPoint, int splitStep,
            byte defaultValue) {
    ...
    private static byte[] cutBytes(byte[] souceByte, int startSplitPoint, int splitStep, byte defaultValue) {
