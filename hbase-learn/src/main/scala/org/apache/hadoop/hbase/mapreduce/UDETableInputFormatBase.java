...
/**
 * A base for {@link UDETableInputFormat}s. Receives a {@link org.apache.hadoop.hbase.client.Connection}, a {@link org.apache.hadoop.hbase.TableName},
 * an {@link org.apache.hadoop.hbase.client.Scan} instance that defines the input columns etc. Subclasses may use
 ...
 * {@link #createRecordReader(org.apache.hadoop.mapreduce.InputSplit, org.apache.hadoop.mapreduce.TaskAttemptContext)} and {@link #getSplits(org.apache.hadoop.mapreduce.JobContext)},
 * will call {@link #initialize(org.apache.hadoop.mapreduce.JobContext)} as a convenient centralized location to handle
...
public abstract class UDETableInputFormatBase
  ...
  private static final Log LOG = LogFactory.getLog(UDETableInputFormatBase.class);
  ...
  /** The {@link org.apache.hadoop.hbase.client.Admin}. */
  private Admin admin;
  /** The {@link org.apache.hadoop.hbase.client.Table} to scan. */
  private Table table;
  /** The {@link org.apache.hadoop.hbase.client.RegionLocator} of the table. */
  private RegionLocator regionLocator;
  /** The reader scanning the table, can be a custom one. */
  private UDETableRecordReader UDETableRecordReader = null;
  /** The underlying {@link org.apache.hadoop.hbase.client.Connection} of the table. */
  ...
  /**
   * Builds a {@link UDETableRecordReader}. If no {@link UDETableRecordReader} was provided, uses
   * the default.
   *
  ...
  public RecordReader<ImmutableBytesWritable, Result> createRecordReader(
    ...
    final UDETableRecordReader trr =
        this.UDETableRecordReader != null ? this.UDETableRecordReader : new UDETableRecordReader();
  ...
  /**
   * Allows subclasses to get the {@link org.apache.hadoop.hbase.client.RegionLocator}.
   */
  ...
  /**
   * Allows subclasses to get the {@link org.apache.hadoop.hbase.client.Table}.
   */
  ...
  /**
   * Allows subclasses to get the {@link org.apache.hadoop.hbase.client.Admin}.
   */
   ...
   *
   * @param connection  The {@link org.apache.hadoop.hbase.client.Connection} to the HBase cluster. MUST be unmanaged. We will close.
   * @param tableName  The {@link org.apache.hadoop.hbase.TableName} of the table to process.
  ...
  /**
   * Allows subclasses to set the {@link UDETableRecordReader}.
   *
   * @param UDETableRecordReader A different {@link UDETableRecordReader}
   *   implementation.
   */
  protected void setUDETableRecordReader(UDETableRecordReader UDETableRecordReader) {
    this.UDETableRecordReader = UDETableRecordReader;
  }
   ...
   * {@link #initializeTable(org.apache.hadoop.hbase.client.Connection, org.apache.hadoop.hbase.TableName)}.
   *
