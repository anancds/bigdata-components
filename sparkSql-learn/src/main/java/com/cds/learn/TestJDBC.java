...
public class TestJDBC {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:hive2://10.65.223.244:10007", "root", "hik12345");
            ...
            for (int k = 0; k < inNums; k++) {
                if (0 == k && k == inNums - 1) {
                    stringBuilderIn
                            .append("select * from testTable  where 1=1 and ((inte in (" + String.valueOf(k) + "))");
                } else if (0 == k) {
                    stringBuilderIn
                            .append("select * from testTable  where 1=1 and ((inte in (" + String.valueOf(k) + ",");
                } else {
                    if (0 == k % 100) {
                        ...
                        stringBuilderIn.append(") or inte in (");
                    } else if (inNums - 1 == k) {
