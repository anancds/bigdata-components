...
import com.cds.learn.httpclient.builder.HttpClientBuilderV2;
...
//      client4HTTP = HttpClientBuilder.create().build();
  ...
  public static void main(String[] args) throws HttpProcessException {
    System.out.println(UdeHttpClient.get(HttpConfig.custom().url("https://www.baidu.com")));
  }
}
